...
uris = [
    ...
    'radio://0/10/2M/E7E7E7E703',  # cf_id 2, startup position [0.5, 0.5]
...
sequence = [
    ...
    (1,    0,      Goto(-0.5,  0.5,   0.5, 1)),
    (1,    1,      Goto(-0.5,  -0.5,   0.5, 1)),
    (1,    2,      Goto(-0.5,  -0.5,   0.5, 1)),

    (2,    0,      Goto(0.5, 0.5, 0.5, 1)),
    (2,    1,      Goto(-0.5, 0.5, 0.5, 1)),
    (2,    2,      Goto(-0.5, -0.5, 0.5, 1)),

    (3,    0,      Goto(0.5,  -0.5,   0.5, 1)),
    (3,    1,      Goto(0.5,  0.5,   0.5, 1)),
    (3,    2,      Goto(-0.5,  0.5,   0.5, 1)),

    (4,    0,      Goto(0.5,  -0.5,   0.5, 1)),
    (4,    1,      Goto(0.5,  -0.5,   0.5, 1)),
    (4,    2,      Goto(0.5,  0.5,   0.5, 1)),

    (5,    0,      Goto(0.5,  0.5,   0.5, 1)),
    (5,    1,      Goto(0.5,  -0.5,   0.5, 1)),
    (5,    2,      Goto(0.5,  -0.5,   0.5, 1)),

    (6,    0,      Goto(-0.5,  0.5,   0.5, 1)),
    (6,    1,      Goto(0.5,  0.5,   0.5, 1)),
    (6,    2,      Goto(0.5,  -0.5,   0.5, 1)),

    (7,    0,      Goto(-0.5,  -0.5,   0.5, 1)),
    (7,    1,      Goto(-0.5,  0.5,   0.5, 1)),
    (7,    2,      Goto(0.5,  0.5,   0.5, 1)),

    (8,    0,      Goto(-0.5, -0.5, 0.5, 1)),
    (8,    1,      Goto(-0.5, -0.5, 0.5, 1)),
    (8,    2,      Goto(-0.5, 0.5, 0.5, 1)),
